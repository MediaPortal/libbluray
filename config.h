...
#define PACKAGE_STRING "libbluray 1.2.0"
...
/* Define to Build JAR file java_versions = -Djava_version_asm=1.5 -Djava_version_bdj=1.4 */
/* #define USING_BDJAVA_BUILD_JAR */

/* Using with "USING_BDJAVA_BUILD_JAR" Define using JAVA9+ java_versions = -Djava_version_asm=1.6 -Djava_version_bdj=1.6 */
/* #define USING_JAVAC_9 */
